...
namespace NetCoders.LINQtoSQL.Intro
{
    ...
    partial void DeletetbFilmes(tbFilmes instance);
		...
		public ProducoesArtisticasDataContext() : 
				base(global::NetCoders.LINQtoSQL.Intro.Properties.Settings.Default.ProducoesArtisticasConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnNomeChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="tbFilme_tbAtores", Storage="_tbFilmes", ThisKey="FilmeID", OtherKey="FilmeID", IsForeignKey=true)]
    ...
    partial void OnGeneroChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="tbFilme_tbAtores", Storage="_tbAtores", ThisKey="FilmeID", OtherKey="FilmeID")]
